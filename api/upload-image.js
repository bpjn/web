// api/upload-image.js
// POST /api/upload-image — upload a base64-encoded image to Cloudinary.
// Requires a valid admin token in the request body.
//
// Environment variables:
//   CLOUDINARY_CLOUD_NAME   (required)
//   CLOUDINARY_UPLOAD_PRESET (required — must be an unsigned preset)
...
export default async function handler(req, res) {
  ...
  try {
    const body = new URLSearchParams({
      file: `data:${mimetype ?? 'image/jpeg'};base64,${filedata}`,
